...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.code_rate_0 = code_rate_0 = 4
    ...
    def get_code_rate_0(self):
        return self.code_rate_0

    def set_code_rate_0(self, code_rate_0):
        self.code_rate_0 = code_rate_0
    ...
    def set_bw(self, bw):
        self.bw = bw
        self.pfb_arb_resampler_xxx_0.set_rate(self.samp_rate/self.bw)
        self.qtgui_freq_sink_x_0.set_frequency_range(470.3e6, self.bw)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(470.3e6, self.bw)
